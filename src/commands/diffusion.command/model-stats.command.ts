...
export const modelStats = new CommandGeneric(
  "modelStats",
  ["ms"],
  "Directly gives you the stats of your mentioned model!",
  "ms <model name>",
  "DIFFUSION",
  async (client, message, args) => {
    if (args.length > 0) {
      ...
      message.reply(
        ErrorEmbed(client, message).setDescription("Model not found!")
      );
      return;
    }
    message.reply(
